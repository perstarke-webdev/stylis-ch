...
Users should be able to quickly understand which type of Wohn- und Einrichtungsberatung fits their situation, see that Caroline Stupf has deep practical experience, trust that the service is personal and independent, and contact her without friction. The primary conversion path is contact first, with WhatsApp especially prominent on the contact page.
...
The palette should stay consistent: warm paper/surface neutrals, deep readable ink, orange as the strong primary contact CTA and hero eyebrow accent, and teal as a restrained supporting accent for section labels, trust elements, and subtle tints. Avoid strong dark brown as a dominant colour. Teal should not become a full-section background or button colour.
...
- Design for CMS compatibility with a compact component set; aim below 10 component groups when clean, and keep 14 as the hard cap.
